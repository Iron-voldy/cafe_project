...
const Home = () => {
    const features = [
        { icon: FaCartShopping, title: 'Order Management', desc: 'Track and manage all customer orders seamlessly from counter or online platforms.', link: '/orders', color: '#00e5ff', faIcon: 'fa-cart-shopping' },
        { icon: FaCreditCard, title: 'Billing & Payments', desc: 'Automated billing, secure multiple payment methods, and instant invoice generation.', link: '/payments', color: '#10b981', faIcon: 'fa-credit-card' },
        { icon: FaBookOpen, title: 'Menu & Inventory', desc: 'Full menu management with real-time inventory tracking, recipe costs, and low-stock alerts.', link: '/menu', color: '#f59e0b', faIcon: 'fa-book-open' },
        { icon: FaCalendarCheck, title: 'Table & Reservations', desc: 'Manage interactive table layouts, live availability, and online customer reservations.', link: '/tables', color: '#a855f7', faIcon: 'fa-calendar-check' },
    ];
