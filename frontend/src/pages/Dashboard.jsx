...
const Dashboard = () => {
    ...
    const customerStatCards = [
        { title: 'My Orders',       value: stats.myOrders,       icon: 'fa-cart-shopping',  color: '#00e5ff', link: '/orders' },
        { title: 'My Reservations', value: stats.myReservations, icon: 'fa-calendar-check', color: '#a855f7', link: '/tables' },
    ...
    const customerActions = [
        ...
        { title: 'Reservation',      icon: 'fa-calendar-check', link: '/tables',      color: '#a855f7' },
        { title: 'My Profile',       icon: 'fa-user',           link: '/profile',     color: '#00e5ff' },
        { title: 'Order History',    icon: 'fa-clock-rotate-left', link: '/profile',  color: '#10b981' },
    ];
